<%@page import=com.jspider.netflix_servlet_projects.dto.Movie %>
<%@page import="java.util.List"%>
<%@page import= "com.jspider.netflix_servlet_projects.dao.MovieDao"%>
							...
							<div class="carousel-item bollywood-item">
								<div class="row">
									...
									if (movie.getType().equalsIgnoreCase("BOLLYWOOD")) {
										String base64Image = Base64.getEncoder().encodeToString(movie.getImageFetch());
									%>
